...
NOTE: Before you can start playing 1337ris, you need to copy it to your hard drive first -- otherwise it won't be able to start up. Where you put it doesn't matter -- the Applications folder is a good place.

1337ris is a Universal application, meaning it can run on both Intel and PowerPC-based Macs. I am not sure of what the system requirements are, other than that, because a lot of the Mac OS X-specific building was done by py2app. I will assume that, like most Universal apps, you need to have Mac OS X version 10.3.9 or above, but I am not sure about that. All I can say is that, aside from my MacBook Pro, the only other Mac I could test 1337ris on was running OS X 10.3.0, and it didn't work on that machine.

If it doesn't work on your machine, then you can always try downloading the source code (http://students.washington.edu/htwcoder/1337ris/1337ris_src.zip) instead, although you'll have to download and install pygame yourself. More details are in the Read Me file that comes with the source code.
